...
const ProductCard = ({ product }) => {
  ...
  return (
    <div className="w-full bg-white p-4 shadow rounded relative border transform transition-transform duration-300 hover:scale-105">
      <img
        src={product.image}
        alt={product.name}
      ...
      >
        ...
        <span className="hidden group-hover:block">Add Cart</span>
      </button>
    </div>
  );
};
